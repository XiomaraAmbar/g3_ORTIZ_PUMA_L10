...
public class BTree2<E extends Comparable<E>> {
    ...
    public BTree2(int orden){
        this.orden = orden;
        this.root = null;
        this.maxKeys = orden - 1;
        this.minKeys = (int)Math.ceil(orden / 2.0) - 1;
        this.minChildren = minKeys + 1;
        this.maxChildren = orden;
        this.midPos = minKeys + 1;
    }
